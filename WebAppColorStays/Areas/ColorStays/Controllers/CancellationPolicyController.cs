...
{   
    ...
    public class CancellationPolicyController : Controller
    {
        ...
        private void Title()
        {
            ViewBag.Title = "Cancellation Policy";
        }
        //Ends


        //CancellationPolicyAutoComplete
        [HttpGet]
        public async Task<JsonResult> SuggestCancellationPolicy(string term)
        {
            ...
            using (HttpClient client = APIColorStays.Initial())
            {
                ...
                HttpResponseMessage res = await client.GetAsync("CancellationPolicy/SuggestCancellationPolicy/" + term + "/" + CompId, HttpCompletionOption.ResponseHeadersRead);
